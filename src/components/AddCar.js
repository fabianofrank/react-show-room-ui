          ...
          <div className="flex flex-col md:flex-row md: gap-2">
            ...
            <div>
              <label className="block text-gray-700 text-base font-bold mb-2" htmlFor="car-image">
                Car Image
                <input className="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus: outline-main focus:placeholder:text-grey" id="car-image" type="file" placeholder="Upload Car Image" required />
              </label>
            </div>
          </div>
